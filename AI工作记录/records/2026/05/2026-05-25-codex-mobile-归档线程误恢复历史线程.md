...
- 用户随后要求整理仓库里遗留的未提交说明文档与工作记录。
- 已完成只读检查，并判断：
  - `.gitignore`、`AGENTS.md`、`DESIGN.md` 可直接作为“项目结构说明收敛”一组提交；
  - `2026-05-23-codex-mobile-图片可见触发方式说明.md` 可直接提交；
  - `2026-05-23-codex-mobile-安装包路径定位.md` 需要先补齐记录元数据并去掉重复标题；
  - `2026-05-25-codex-mobile-项目文件整理需求巡检.md` 需要把“当前 Git 工作区”改成带时间限定的历史表述。
- 本轮未新增代码修改；整理完成后按文档/记录收尾提交。
